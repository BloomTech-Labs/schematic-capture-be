...
module.exports = (req, res, next) => {
    ...
    const data = {
        ...
        from: { email: "invitation@schematiccapture.com", name: "Schematic Capture" },
    ...
    axios.post("https://api.sendgrid.com/v3/mail/send", data, config).then(() => {
        ...
        res.status(500).json({ error: error, message: 'Failed to send email to user.', step: 'sendEmailInvite middleware' });
    });
}